...
static void build_payload(void) {
    ...
    payload.company_id[0]  = ZMK_BLE_ADV_COMPANY_ID_0;
    payload.company_id[1]  = ZMK_BLE_ADV_COMPANY_ID_1;
    payload.protocol_id[0] = ZMK_BLE_ADV_PROTOCOL_ID_0;
    payload.protocol_id[1] = ZMK_BLE_ADV_PROTOCOL_ID_1;
